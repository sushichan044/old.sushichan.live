...
import { CardCustomizeProps } from '@/components/base/card'
import EmbedCard from '@/components/base/card/embedCard'
import { RawImg, RawImgWithoutSize } from '@/components/base/image/rawImg'
import Link from '@/components/base/link'
import s from '@/components/ui/card/url-card.module.scss'
